...
import Support.ClientStream (clientHTTPStreamLifecycle, clientStreamLifecycle, clientUploadLifecycle)
...
kvMalformedJSONRecovery namespace =
    bracket
        (pure (KV namespace))
...
workersAIProbe :: JSVal -> JSVal -> JSVal -> IO JSVal
workersAIProbe = WorkersAIProbe.probeWorkersAI
foreign export javascript "workersAIProbe" workersAIProbe :: JSVal -> JSVal -> JSVal -> IO JSVal
